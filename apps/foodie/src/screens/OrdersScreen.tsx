...
const FOOD_QUOTES = [
  {
    q: '"Jo kal khaaya tha, woh aaj bhi yaad hai."',
    by: "— Every foodie, ever",
  },
  {
    q: '"Khana pakka ho ya na ho, plate full honi chahiye."',
    by: "— Dadi ka gyaan",
  },
  {
    q: '"Tell me what you eat, I\'ll tell you who you are."',
    by: "— Brillat-Savarin",
  },
  { q: '"Cooking is love made visible."', by: "— Kitchen wisdom" },
  { q: '"Bhookh is the best sauce."', by: "— Hunger, probably" },
  {
    q: '"A good meal makes the world a little smaller."',
    by: "— Anthony Bourdain",
  },

  // Desi Tadka ✨
  {
    q: '"Garam chai aur baarish... bas zindagi set hai."',
    by: "— Dil se desi",
  },
  {
    q: '"Butter lagao toh paratha bhi premium lagta hai."',
    by: "— Punjabi philosophy",
  },
  {
    q: '"Jab tak plate mein last bite na ho, tab tak pet nahi maanta."',
    by: "— True foodie",
  },
  {
    q: '"Street food ka taste hygiene se nahi, emotions se aata hai."',
    by: "— Golgappa lovers union",
  },
  {
    q: '"Ek extra roti hamesha pet ke liye nahi, dil ke liye hoti hai."',
    by: "— Maa",
  },
  {
    q: '"Maggi sirf food nahi, har student ka emotion hai."',
    by: "— Hostel diaries",
  },
  {
    q: '"Shaadiyon mein log rishtedaar kam, starters zyada dekhte hain."',
    by: "— Indian weddings",
  },
  {
    q: '"Golgappe count nahi hote, bas khaye jaate hain."',
    by: "— Pani puri experts",
  },
  {
    q: '"Chicken biryani ke saamne diet bhi respect se side ho jaati hai."',
    by: "— Midnight cravings",
  },
  {
    q: '"Maa ke haath ka khana Michelin star se upar hota hai."',
    by: "— Every Indian ever",
  },
  {
    q: '"Tandoori smoke aur butter ki khushboo... bas wahi asli therapy hai."',
    by: "— Food therapy",
  },
  {
    q: '"Jalebi garam ho aur rabdi thandi... wahin asli balance hai."',
    by: "— Sweet tooth society",
  },
  {
    q: '"Bhookh lage toh simple dal chawal bhi five-star lagta hai."',
    by: "— Indian soul",
  },

  // English Food Vibes 🍔
  {
    q: '"Good food is a hug you can taste."',
    by: "— Comfort food lovers",
  },
  {
    q: '"Life happens, snacks help."',
    by: "— Universal truth",
  },
  {
    q: '"First we eat, then we do everything else."',
    by: "— M.F.K. Fisher",
  },
  {
    q: '"The smell of fresh food can heal a bad day."',
    by: "— Kitchen emotions",
  },
  {
    q: '"There’s no heartbreak that hot pizza can’t soften."',
    by: "— Late night wisdom",
  },
  {
    q: '"Food tastes better when shared with people you love."',
    by: "— Table talks",
  },
  {
    q: '"A crispy bite can fix more problems than advice ever will."',
    by: "— Fried food philosophy",
  },
  {
    q: '"Every recipe carries a memory."',
    by: "— Home kitchens",
  },
  {
    q: '"Freshly baked bread is what happiness smells like."',
    by: "— Bakery mood",
  },
  {
    q: '"Some memories begin with the words: take one more bite."',
    by: "— Food nostalgia",
  },
]
      ...
      <SafeAreaView style={s.safe} edges={["top"]}>
        ...
        >
          ...
          <View style={s.quoteCard}>
            <LinearGradient
              colors={["rgba(245,166,35,0.10)", "rgba(245,166,35,0.03)"]}
          ...
          {cartCount > 0 ? (
            <Pressable
              ...
              onPress={() =>
                navigation.navigate("Home", {
                  screen: "Cart",
                  params: { restaurantName: "Current restaurant" },
                })
              }
            >
              ...
              <Text style={s.activeHint}>
                Tap to review your cart and place the order
              </Text>
            </Pressable>
          ) : (
            <View style={s.emptyCart}>
              ...
              <Text style={s.emptyCartText}>
                Browse home and start building your cart.
              </Text>
            </View>
          )}
          ...
          <View style={s.actionsGrid}>
            {QUICK_ACTIONS.map((a) => (
              ...
              >
                <View
                  style={[s.actionIcon, { backgroundColor: `${a.color}18` }]}
                >
                  <MaterialCommunityIcons
                    name={a.icon}
                    size={22}
          ...
          <ScrollView
            ...
            contentContainerStyle={s.favsRow}
          >
            {FAVOURITES.map((r) => (
              <Pressable
                key={r.id}
              ...
              <View key={order.id} style={s.orderCard}>
                ...
                <View style={s.orderActions}>
                  <Pressable
                    ...
                    onPress={() => {
                      setCartCount(
                        Math.max(Number.parseInt(order.items, 10) || 1, 1),
                      )
                      navigation.navigate("Home", {
                        screen: "Cart",
                        params: { restaurantName: order.place },
                      })
                    }}
                  >
                    <MaterialCommunityIcons
